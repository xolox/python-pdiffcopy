"""
Documentation build configuration file for the `pdiffcopy` package.

This Python script contains the Sphinx configuration for building the
documentation of the `pdiffcopy` project. This file is execfile()d
...
# Add the 'pdiffcopy' source distribution's root directory to the module path.
...
from pdiffcopy import __version__ as pdiffcopy_version  # noqa

# The short X.Y version.
version = '.'.join(pdiffcopy_version.split('.')[:2])

# The full version, including alpha/beta/rc tags.
release = pdiffcopy_version
